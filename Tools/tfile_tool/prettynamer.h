...
class PrettyNamer
{
    ...
    private:
        ...
        {
            {"FDAT.T0", "WesternShoreTilemap"},
            {"FDAT.T1", "WesternShoreMapDB"},
            {"FDAT.T2", "WesternShoreScript"},
            {"FDAT.T3", "GarrisonTilemap"},
            {"FDAT.T4", "GarrisonMapDB"},
            {"FDAT.T5", "GarrisonScript"},
            {"FDAT.T6", "CentralVillageTilemap"},
            {"FDAT.T7", "CentralVillageMapDB"},
            {"FDAT.T8", "CentralVillageScript"},
            {"FDAT.T9", "WesternShoreTilemap"},
            {"FDAT.T10", "WesternShoreMapDB"},
            {"FDAT.T11", "WesternShoreScript"},
            {"FDAT.T12", "CathedralTilemap"},
            {"FDAT.T13", "CathedralMapDB"},
            {"FDAT.T14", "CathedralScript"},
            {"FDAT.T15", "BigMineTilemap"},
            {"FDAT.T16", "BigMineMapDB"},
            {"FDAT.T17", "BigMineScript"},
            {"FDAT.T18", "NecronsColiseumTilemap"},
            {"FDAT.T19", "NecronsColiseumMapDB"},
            {"FDAT.T20", "NecronsColiseumScript"},
            {"FDAT.T21", "GuyrasLairTilemap"},
            {"FDAT.T22", "GuyrasLairMapDB"},
            {"FDAT.T23", "GuyrasLairScript"},
            {"FDAT.T24", "WeirdDebugMapTilemap"},
            {"FDAT.T25", "WeirdDebugMapMapDB"},
            {"FDAT.T26", "WeirdDebugMapScript"},
            {"FDAT.T27", "TextureDatabase"}, // TODO/FIXME: Find a better name for this file
            {"FDAT.T28", "GameDatabase"},
            {"FDAT.T29", "WeaponDaggerViewmodel"},
            {"FDAT.T30", "WeaponShortSwordViewmodel"},
            {"FDAT.T31", "WeaponKnightSwordViewmodel"},
            {"FDAT.T32", "WeaponMorningStarViewmodel"},
            {"FDAT.T33", "WeaponBattleHammerViewmodel"},
            {"FDAT.T34", "WeaponBastardSwordViewmodel"},
            {"FDAT.T35", "WeaponCrescentAxeViewmodel"},
            {"FDAT.T36", "WeaponFlameSwordViewmodel"},
            {"FDAT.T37", "WeaponShidenViewmodel"},
            {"FDAT.T38", "WeaponSpiderViewmodel"},
            {"FDAT.T39", "WeaponIceBladeViewmodel"},
            {"FDAT.T40", "WeaponSeathsSwordViewmodel"},
            {"FDAT.T41", "WeaponMoonlightSwordViewmodel"},
            {"FDAT.T42", "WeaponDarkSlayerViewmodel"},
            {"FDAT.T43", "WeaponBowViewmodel"},
            {"FDAT.T44", "WeaponArbalestViewmodel"},

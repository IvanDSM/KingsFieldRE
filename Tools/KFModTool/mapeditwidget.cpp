...
void MapEditWidget::objectInstanceHovered(size_t instanceIndex)
{
    ...
    QTableWidgetItem *item5 = new QTableWidgetItem(QString::number(instance.field_0x6));
    ui->objectInstanceTable->setItem(0, 5, item5);
    QTableWidgetItem *item6 = new QTableWidgetItem(QString::number(instance.field_0x7));
    ui->objectInstanceTable->setItem(0, 6, item6);
    QTableWidgetItem *item7 = new QTableWidgetItem(QString::number(instance.field_0x8));
    ui->objectInstanceTable->setItem(0, 7, item7);
    QTableWidgetItem *item8 = new QTableWidgetItem(QString::number(instance.field_0x9));
    ui->objectInstanceTable->setItem(0, 8, item8);
    QTableWidgetItem *item9 = new QTableWidgetItem(QString::number(instance.field_0xa));
    ui->objectInstanceTable->setItem(0, 9, item9);
    QTableWidgetItem *item10 = new QTableWidgetItem(QString::number(instance.field_0xb));
    ui->objectInstanceTable->setItem(0, 10, item10);
    QTableWidgetItem *item11 = new QTableWidgetItem(QString::number(instance.field_0xc));
    ui->objectInstanceTable->setItem(0, 11, item11);
    QTableWidgetItem *item12 = new QTableWidgetItem(QString::number(instance.field_0xd));
    ui->objectInstanceTable->setItem(0, 12, item12);
    QTableWidgetItem *item13 = new QTableWidgetItem(QString::number(instance.Flags[0]));
    ui->objectInstanceTable->setItem(0, 13, item13);
    QTableWidgetItem *item14 = new QTableWidgetItem(QString::number(instance.Flags[1]));
    ui->objectInstanceTable->setItem(0, 14, item14);
    QTableWidgetItem *item15 = new QTableWidgetItem(QString::number(instance.Flags[2]));
    ui->objectInstanceTable->setItem(0, 15, item15);
    QTableWidgetItem *item16 = new QTableWidgetItem(QString::number(instance.Flags[3]));
    ui->objectInstanceTable->setItem(0, 16, item16);
    QTableWidgetItem *item17 = new QTableWidgetItem(QString::number(instance.Flags[4]));
    ui->objectInstanceTable->setItem(0, 17, item17);
    QTableWidgetItem *item18 = new QTableWidgetItem(QString::number(instance.Flags[5]));
    ui->objectInstanceTable->setItem(0, 18, item18);
    QTableWidgetItem *item19 = new QTableWidgetItem(QString::number(instance.Flags[6]));
    ui->objectInstanceTable->setItem(0, 19, item19);
    QTableWidgetItem *item20 = new QTableWidgetItem(QString::number(instance.Flags[7]));
    ui->objectInstanceTable->setItem(0, 20, item20);
    QTableWidgetItem *item21 = new QTableWidgetItem(QString::number(instance.Flags[8]));
    ui->objectInstanceTable->setItem(0, 21, item21);
    QTableWidgetItem *item22 = new QTableWidgetItem(QString::number(instance.Flags[9]));
...
void MapEditWidget::on_objectInstanceTable_itemChanged(QTableWidgetItem *item)
{
    ...
    switch(item->row())
    {
        ...
        case (14): instance.Flags[0] = item->text().toUShort(); break;
        case (15): instance.Flags[1] = item->text().toUShort(); break;
        case (16): instance.Flags[2] = item->text().toUShort(); break;
        case (17): instance.Flags[3] = item->text().toUShort(); break;
        case (18): instance.Flags[4] = item->text().toUShort(); break;
        case (19): instance.Flags[5] = item->text().toUShort(); break;
        case (20): instance.Flags[6] = item->text().toUShort(); break;
        case (21): instance.Flags[7] = item->text().toUShort(); break;
        case (22): instance.Flags[8] = item->text().toUShort(); break;
        case (23): instance.Flags[9] = item->text().toUShort(); break;
    }
    curMap->setChanged();
}
